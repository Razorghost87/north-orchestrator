...
export const AGENT_MAX_TOKENS: Record<AgentRole, number> = {
    Architect: 1200,
    PM: 800,
    MobileEngineer: 1000,
...
export const SYNTHESIS_SYSTEM_PROMPT = `You are the Lead Orchestrator synthesizing a multi-agent meeting for the North finance app.
